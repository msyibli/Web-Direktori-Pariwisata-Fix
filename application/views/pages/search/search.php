<div class="hero-wrap js-fullheight" style="background-image: url('assets/images/home/home-1.jpg');">
    <div class="overlay"></div>
    <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
            <div class="col-md-9 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                <h1 class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><strong>Hasil Pencarian</strong> Anda!</h1>
                <p data-scrollax="properties: { translateY: '30%', opacity: 1.6 }" style="text-align: justify;">Di bawah ini menampilkan hasil pencarian berdasarkan Kode Provinsi dan Kode Kabupaten, serta Penyedia Makan dan Minum dan Daya Tarik Wisata (DTW) sekitar daerah Jasa Akomodasi yang dicari.</p>
            </div>
        </div>
    </div>
</div>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="destination">
                                                                    ...
                                                                    ?>
                                                                        <a href="<?= base_url('Jasa_akomodasi/jasa_akomodasi_detail/' . $d->id); ?>" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(<?= $d->photo_url ?>);">
                                                                    ...
                                                                    ?>
                                                                        <a href="<?= base_url('Penyedia_makan_dan_minum/penyedia_makan_dan_minum_detail/' . $d->id); ?>" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(<?= $d->photo_url ?>);">
                                                                            <div class="icon d-flex justify-content-center align-items-center">
                                                                                <span class="icon-search2"></span>
                                                                            </div>
                                                                        </a>
                                                                    ...
                                                                    ?>
                                                                        <a href="<?= base_url('Daya_tarik_wisata/daya_tarik_wisata_detail/' . $d->id); ?>" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(<?= $d->photo_url ?>);">
                                                                            <div class="icon d-flex justify-content-center align-items-center">
                                                                                <span class="icon-search2"></span>
                                                                            </div>
                                                                        </a>
                                                                    ...
                                                                    <div class="text p-3">
                                                                        <div class="d-flex">
                                                                            <div class="one">
                                                                                <?php if ($d->kategori == 'akomodasi') {
                                                                                ?>
                                                                                    <h3><a href="<?= base_url('Jasa_akomodasi/jasa_akomodasi_detail/' . $d->id); ?>"><?= $d->nama_komersial ?></a></h3>
                                                                                <?php
                                                                                } else if ($d->kategori == 'PMM') {
                                                                                ?>
                                                                                    <h3><a href="<?= base_url('Penyedia_makan_dan_minum/penyedia_makan_dan_minum_detail/' . $d->id); ?>"><?= $d->nama_komersial ?></a></h3>
                                                                                <?php
                                                                                } else {
                                                                                ?>
                                                                                    <h3><a href="<?= base_url('Daya_tarik_wisata/daya_tarik_wisata_detail/' . $d->id); ?>"><?= $d->nama_komersial ?></a></h3>
                                                                                <?php
                                                                                }
                                                                                ?>
                                                                                <p class="rate">
