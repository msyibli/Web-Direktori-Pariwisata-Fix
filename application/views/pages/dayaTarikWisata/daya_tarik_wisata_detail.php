<div class="hero-wrap js-fullheight" style="background-image: url(<?= base_url('assets/images/dayaTarikWisata/daya-tarik-wisata-9.jpg') ?>);">
    <div class="overlay"></div>
    <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
            <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
                <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="<?= base_url(); ?>">Home</a></span>/ <span class="mr-2"><a href="<?= base_url('daya_tarik_wisata'); ?>">DTW</a></span>/ <span>Detail DTW</span></p>
                    ...
                    <div class="col-md-12 hotel-single mt-4 mb-5 ftco-animate">
                        <div class="row justify-content-between">
                            ...
                            <div class="col-md-3 text-right">
                                <a href="<?= base_url('Daya_tarik_wisata/dtw_download/' . $d_d->id) ?>" target="_blank" class="btn btn-danger">Download Direktori</a>
                            </div>
                        </div>
                        <p class="rate mb-1">
